;(function(w){
    ...
    Maze.prototype = {
        ...
        createWall:function(x,y,w,h){
            var shadow = new createjs.Shadow('#13c819',0,0,5);
            var shape = new createjs.Shape();
            shape.graphics.beginFill('rgba(19,200,25,1)').drawRect(0, 0, w*this.ratio, h*this.ratio);
        ...
        setColor:function(obj){
            var myGraphics = new createjs.Graphics().beginFill("#ff0000").drawRect(0, 0,obj.w,obj.h); 
        ...
        createTablet:function(x,y,img){
            ...
            var w = this.tablet.image.width*this.ratio;
            var h = this.tablet.image.height*this.ratio;
            this.tablet.setTransform(x*this.ratio,y*this.ratio, 1, 1,0,0,0,w/2,h/2)
            this.tW = w;
            this.tH = h;
	        this.tablet.on('pressmove',ontouchmove);
    ...
    w.createMaze = function(stage){
        return new Maze(stage);
    }
})(window);
